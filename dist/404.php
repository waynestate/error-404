...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            ga('allWayneState.send', 'event', 'Error', '404', 'page: //<?php echo htmlspecialchars($_SERVER['HTTP_HOST'], ENT_QUOTES, 'UTF-8') . htmlspecialchars($_SERVER['REQUEST_URI'], ENT_QUOTES, 'UTF-8'); ?> ref: <?php echo htmlspecialchars($_SERVER['HTTP_REFERER'], ENT_QUOTES, 'UTF-8'); ?>');
        </script>
    </body>
</html>